...
line_scales = collect(2.0:1.0:3.0)
...
for var_to_measure in vars_to_measure
    for line_scale in line_scales
        for load_scale in load_scales
            ...
            sol_alg = (df_alg."Time", df_alg."Bus-1-Mag")
            sol_dyn = (df_dyn."Time", df_dyn."Bus-1-Mag")
            sol_ms = (df_ms."Time", df_ms."Bus-1-Mag")
            sol_msmb = (df_msmb."Time", df_msmb."Bus-1-Mag")
