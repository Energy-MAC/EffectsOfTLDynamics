...
for var_to_measure in vars_to_measure
    for line_scale in line_scales
        for load_scale in load_scales
            ...
            sol_alg = (df_alg."Time", df_alg."generator-1-1_ir_cnv")
            sol_dyn = (df_dyn."Time", df_dyn."generator-1-1_ir_cnv")
            sol_ms = (df_ms."Time", df_ms."generator-1-1_ir_cnv")
            sol_msmb = (df_msmb."Time", df_msmb."generator-1-1_ir_cnv")
