...
file_name = "twobus_2inv.json"; # choose system 
...
# Specify what is connected to what using tuples - easier to do it here rather than figure it out. 
...
# Workaround while there's issues w L shape 
